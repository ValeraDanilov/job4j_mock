...
import ru.checkdev.site.util.InterviewResponse;
...
public class InterviewsService {
    ...
    public InterviewsService(@Value("${service.mock}") String mockUrl) {
    ...
    public List<InterviewDTO> findAll() throws JsonProcessingException {
        String text = new RestAuthCall(mockUrl + "/interviews/").get();
